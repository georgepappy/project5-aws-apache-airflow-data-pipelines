...
load_songplays_table = LoadFactOperator(
    ...
    aws_credentials_id='aws_credentials',
    append_only=True,
    sql_string = SqlQueries.songplay_table_insert
)
...
load_user_dimension_table = LoadDimensionOperator(
    ...
    aws_credentials_id='aws_credentials',
    append_only=True,
    sql_string = SqlQueries.user_table_insert
)
...
load_song_dimension_table = LoadDimensionOperator(
    ...
    aws_credentials_id='aws_credentials',
    append_only=True,
    sql_string = SqlQueries.song_table_insert
)
...
load_artist_dimension_table = LoadDimensionOperator(
    ...
    aws_credentials_id='aws_credentials',
    append_only=True,
    sql_string = SqlQueries.artist_table_insert
)
...
load_time_dimension_table = LoadDimensionOperator(
    ...
    aws_credentials_id='aws_credentials',
    append_only=True,
    sql_string = SqlQueries.time_table_insert
)
